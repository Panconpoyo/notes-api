package com.ensolvcris.notesappapi.Shared.ExceptionHandler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleResourceValidationException(ResourceValidationException ex) {
        Map<String, Object> body = new HashMap<>();
        body.put("timestamp", LocalDateTime.now());
